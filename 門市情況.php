    ...
    <main id="main">
        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                ?>
                <span align=left style="font-size: 18px;"><a href="門市據點.php"><i class="bi bi-arrow-return-left"></i>&nbsp;返回</a></span>
                ...
                <div class="section-title">
                    ...
                    <div align=center style="padding-bottom:30px;">
                        <h4><?php echo $S_NAME; ?></h4>
                        <br>
                        <form method=get action="門市情況.php">
                            輸入欲訂購數量:
                            <input type="text" name="number" style="width:40px">
                    ...
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th class="table-success">
                                <h4 align="center">甜點名稱</h4>
                            </th>
                            <th class="table-success">
                                <h4 align="center">每日產量</h4>
                            </th>
                        </tr>
                        ...
                        if(empty($number)){
                            ...
                            $sql  = "select * from product where S_ID = '$S_ID' and quantity > $number";
                        }
                        
                        $result = mysqli_query($link, $sql);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr><td>", $row['D_NAME'], "</td><td>", $row['quantity'], "</td></tr>";
                        }
                        ?>
                    </table><br><br>
                </div>
