...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      <a href="index.php" class="logo" style="font-family: Dancing Script"><font color="black">Catorce Dessart</font></a> 
      

      <nav id="navbar" class="navbar order-last order-lg-0" color="black" >
        <ul>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center" data-aos="zoom-in" data-aos-delay="100" >
      <h1 style="font-family: Dancing Script">Catorce Dessart</h1>
      <h2 style="font-family: Dancing Script"><font size="6" color="black">Only the best desserts</font></h2>
      <a href="甜品一覽.php" class="btn-about" style="background-color:black;">瀏覽甜點</a> 
